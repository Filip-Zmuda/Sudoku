...
public class SudokuBoard extends View {
    ...
    private final int cellsHiglightColor;

    private final int letterColor;
    private final int letterColorSolve;
    private final Paint boardColorPaint = new Paint();
    private final Paint cellFillColorPaint = new Paint();
    private final Paint cellsHiglightColorPaint = new Paint();
    ...
    public SudokuBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try{
            ...
            cellsHiglightColor = a.getInteger(R.styleable.SudokuBoard_cellsHiglightColor,0);
    ...
    protected void onMeasure(int width, int height){
        ...
        int dimension = Math.min(this.getMeasuredWidth(), this.getMeasuredHeight());    //pobiera wymiary ekranu użytkownika, aby plansza była zawsze kwadratem
    ...
    protected void onDraw(Canvas canvas){
        ...
        cellsHiglightColorPaint.setStyle(Paint.Style.FILL);
        cellsHiglightColorPaint.setAntiAlias(true);
        cellsHiglightColorPaint.setColor(cellsHiglightColor);
    ...
    private void colorCell(Canvas canvas, int r, int c){
        if(solver.getSelectedColumn() != -1 && solver.getSelectedRow() != -1){
            canvas.drawRect((c-1)*cellSize, 0,c*cellSize, cellSize*9, cellsHiglightColorPaint);
            canvas.drawRect(0, (r-1)*cellSize,cellSize*9, r*cellSize, cellsHiglightColorPaint);
            canvas.drawRect((c-1)*cellSize, (r-1)*cellSize,c*cellSize, r*cellSize, cellsHiglightColorPaint);
        }
